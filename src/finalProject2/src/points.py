...
class PointMap:
  ...
  def __init__(self):
    ...
    #[[0,0,-0.15,-0.99],[0,0,-0.06,.99],[0,0,-0.33,0.99],[0,0,-0.81,0.57],[0,0,-.99,.05],[0,0,-.99,.05],
    self.quats = [[0,0,-0.99,-0.088],[0,0,0.985,0.17],[0,0,0.985,0.17],[0,0,0.985,0.17],[0,0,0.98,0.19],[0,0,0.83,0.54],
		 [0,0,-0.99,-0.12],[0,0,-0.91,0.41],[0,0,-0.86, 0.52],[0,0,-0.85,0.53],[0,0,-0.91,0.41],[0,0,-0.997,-0.07],[0,0,0.91,0.41],
    ...
    #[[49.29,14.00],[50.29,14.34],[51.35,14.00],[52,11.85],[50.97,10.65],[49.49,10.37],
    self.poses = [[47.33,10.4],[45.79,10.95],[43.29,12.00],[40.35,12.86],[39.00,13.26],
		 [38.29,14.6],[37.56,17.5],[36.55,17.41],[34.85,15.99],[33.53,13.99],[32.75,12.90],[30.97,12.05],
