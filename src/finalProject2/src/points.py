  ...
  def __init__(self):
    ...
    self.quats = [[0,0,-0.15,-0.99],[0,0,-0.06,.99],[0,0,-0.33,0.99],[0,0,-0.81,0.57],
		 ...
		 [0,0,0.92,0.39],[0,0,0.99,0.001],[0,0,0.99,0.08],
         	 [0,0,-0.98,0.188],[0,0,-0.97,0.21],[0,0,-0.81,0.57]]  

    self.poses = [[49.29,14.00],[50.29,14.34],[51.35,14.20],[52,11.85],
		 [50.97,10.65],[49.49,10.37],[47.33,10.2],[45.79,10.95],[43.29,12.00],[39.80,12.80],[39.25,13.26],
		 [38.29,14.6],[36.56,17.5],[35.55,17.41],[34.85,15.99],[33.53,13.99],[30.97,12.05],
		 [29.85,12.20],[28.6,13.7],[26.79,15.07],[25.3,15.12],
       		 [20.41,15.24],[13.26,12.12],[11.5,10.54]] 
