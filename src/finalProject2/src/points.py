...
class PointMap:
  ...
  def __init__(self):
    ...
    self.quats = [[0,0,0.15,0.99],[0,0,-0.33,0.99],[0,0,-0.39,0.91],[0,0,-0.7,0.67],
		 [0,0,-0.86,0.51],[0,0,0.998,0.05],[0,0,0.985,0.17],[0,0,0.98,0.19],[0,0,0.83,0.54],
    ...
    self.poses = [[49.29,12.4],[51.35,12.60],[51.8,12.34],[52,11.75],
		 [51.97,10.95],[48.21,10.21],[43.79,11.51],[39.25,13.26],
